          ...
          <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-8 lg:grid-cols-12">
            <div className="z-10 lg:col-span-7">
              ...
              <p className="mb-10 max-w-xl text-xl leading-relaxed text-on-surface-variant">
                The modern monolith for developer observability. Monitor
                traffic, detect anomalies, and resolve infrastructure
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-8">
                  ...
                  <div className="translate-y-4 rounded-2xl border border-outline-variant/30 bg-surface-container-highest/80 p-6 backdrop-blur-md">
                    ...
                    <p className="mb-4 font-label text-xs leading-relaxed text-on-surface-variant">
                      ...
                      Latency increased by 400ms. Potential database lock
                      suspected.
                    </p>
            ...
            <div className="md:col-span-8 flex flex-col justify-between rounded-3xl border border-transparent bg-surface-container-low p-8 transition-all duration-500 hover:border-outline-variant/20">
              <div>
                ...
                <p className="max-w-md leading-relaxed text-on-surface-variant">
                  Streaming logs from your K8s clusters, Lambda functions, or
                  bare metal servers with sub-millisecond latency. Zero data
                  loss architecture.
                </p>
              </div>
...
[AI] Baseline established for 14 microservices`}</code>
            ...
            <div className="md:col-span-4 rounded-3xl border border-transparent bg-surface-container p-8 transition-all duration-500 hover:border-outline-variant/20">
              ...
              <p className="text-sm leading-relaxed text-on-surface-variant">
                Our proprietary LLM analyzes patterns to distinguish between
                routine noise and critical system failures automatically.
              </p>
            </div>
            ...
            <div className="md:col-span-4 rounded-3xl border border-transparent bg-surface-container-low p-8 transition-all duration-500 hover:border-outline-variant/20">
              ...
              <p className="text-sm leading-relaxed text-on-surface-variant">
                Direct SDKs for Node.js, Go, Python, and Rust. Native
                OpenTelemetry support for zero-lock-in observability.
              </p>
            </div>
            ...
            <div className="relative md:col-span-8 flex items-center gap-8 overflow-hidden rounded-3xl border border-transparent bg-surface-container p-8 transition-all duration-500 hover:border-outline-variant/20">
              <div className="flex-1">
                ...
                <p className="text-sm leading-relaxed text-on-surface-variant">
                  A single source of truth for your entire stack. Correlate
                  logs, metrics, and traces in a unified view designed for
                ...
                <div className="space-y-12">
                  <div className="group flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-on-surface-variant">
                        Drop a single line of code into your application or
                        install our lightweight sidecar agent for
                        infrastructure-wide coverage.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="group flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-on-surface-variant">
                        ...
                        identifies structural changes, and highlights
                  ...
                  <div className="group flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-on-surface-variant">
                        Get paged only for what matters. We integrate with
                        Slack, PagerDuty, and Discord to deliver actionable
                        resolutions directly to your team.
                      </p>
                    </div>
                  </div>
                </div>
